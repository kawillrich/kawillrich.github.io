...
let detectEvilCleric = new ClericLevelOneSpells ("Detect Evil", 1, 60, 2, "Everything within 60 feet", 
    function() {console.log('Casting');}, "detect-evil-cleric");

let purifyFoodAndWaterCleric = new ClericLevelOneSpells ("Purify Food and Water", 1, 10, 0, "Makes spoiled or poisoned food or water usable (1 ration/6 waterskins)", 
