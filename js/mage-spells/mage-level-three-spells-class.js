...
let dispelMagic = new MageLevelThreeSpells ("Dispel Magic", 3, 120, 999, "Destroys spells in a 20' cube", function() {console.log('Casting');}, "dispel-magic");
let fireBall = new MageLevelThreeSpells ("Fire Ball", 2, 240, 0, "Explosion in a sphere 40' diameter", function() {console.log('Casting');}, "fire-ball");
...
let invisibilityTenFoot = new MageLevelThreeSpells ("Invisibility 10 feet radius", 3, 120, 999, "All creatures within 10'", function() {console.log('Casting');}, "invisibility-ten-feet");
