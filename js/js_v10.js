...
//Monster classes
let wolf1 = new Monster('Wolf', 40, 5, 6);
let wolf2 = new Monster('Wolf', 40, 5, 6);
...
//need a check that if monster hp is <0 it displays 'Dead';
//MAYBE HAVE TWO DIFFERENT DIVS, ONE JUST FOR HP AND ONE FOR THE REST
//MAYBE HAVE THE EVENT LISTENER USE TWO DIFFERENT FUNCTIONS, 
...
//      alsoInvokeMe();    
// });
//MAYBE HAVE AN IF FUNCTION, IF THE MONSTER DATA SHOWS 'DEAD', THEN KEEP SHOWING 'DEAD'
...
function functAttackMonsterOne() {
        ...
        <h4 id="monster-one-hp">Health Points: ${wolf1.healthPoints}</h4>`;
            ...
            //monsterOneStatus.innerHTML = `<h4>Dead</h4>`;
...
function functAttackMonsterTwo() {
        ...
        <h4 id="monster-two-hp">Health Points: ${wolf2.healthPoints}</h4>`;
            ...
            //monsterTwoStatus.innerHTML = `<h4>Dead</h4>`;
